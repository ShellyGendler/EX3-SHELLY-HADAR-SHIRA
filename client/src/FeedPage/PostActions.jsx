        ...
        <div>
            <div className="post-actions">
                <div className="actions">
                    <div className={"action"} onClick={handleLikeClick}>
                        <img height="24px" width="24px" src={`../actions/${!isLiked ? "like" : "liked"}.svg`} alt="like" />
                        <span>Like{isLiked && "d"}</span>
                    </div>
                    <div className="action" onClick={() => setCommenting(!isCommenting)}>
                        <img height="24px" width="24px" src="../actions/comment.svg" alt="comment" />
                        <span>Comment</span>
                    </div>
            ...
            {isCommenting && (
                <div className="comment-box">
                    <textarea className="comment-area" placeholder="Add a comment..." value={newComment} onChange={(e) => setNewComment(e.target.value)} />
