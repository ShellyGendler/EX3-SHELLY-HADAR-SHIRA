    ...
    return (
        ...
        <form onSubmit={handleSignUpSubmit} id="form">
            <div>
                <label>
                    {" "}
                    First name, last name and user name should contain letters only
                    <br></br>
                    <input
                        class="form-label"
            ...
            <div className="center">
                <label>
                    <div style={{ display: "flex", flexDirection: "column" }}>
                        <label for="files" style={{ color: "grey", textAlign: "center" }}>
                            Select an Image
                        </label>
                        <input
                            id="files"
                    ...
                    {pic && (
                        <>
                            <div></div>
                            <img src={pic} alt="Selected Preview" style={{ width: "200px", height: "200px" }} />
                        </>
                    )}
                </label>
            </div>
